...
from Sampling.poisson_disk_sampling import PoissonDiskSampling as Poisson
from Normalization import normalization

'''
This class is created copyng the default ModelNet loader of pytorch_geometric
now i'm on hurry to test the modification where you only extend the dataset!
'''

class PoissonModelNet(InMemoryDataset):
    ...
    def __init__(self,
        ...
        self.name = name
        super(PoissonModelNet, self).__init__(root, transform, pre_transform,
                                       pre_filter)
